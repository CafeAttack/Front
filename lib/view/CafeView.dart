                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 5,),
                        SizedBox(
                          child: Text("서울 노원구 광운로 25 2층",style: TextStyle(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 5,),
                        SizedBox(
                          child: Text("매일 11:00 ~ 23:00 영업",style: TextStyle(
                              fontWeight: FontWeight.w300,
                              fontFamily: freesentation,
                              fontSize: 20
                          ),),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 5,),
                        SizedBox(
                          child: Text("02-6953-0749",style: TextStyle(
                              fontWeight: FontWeight.w300,
                              fontFamily: freesentation,
                              fontSize: 20
                          ),),
                    ...
                    Row(
                      ...
                      children: [
                        SizedBox(
                          child: Text("카페유형", style: TextStyle(
                              fontSize: 20,
                              fontFamily: freesentation,
                              fontWeight: FontWeight.w500
                          ),textAlign: TextAlign.center,),
                        ...
                        SizedBox(width: 5,),
                        SizedBox(
                          child: Text("프랜차이즈 / 테이크 아웃",style: TextStyle(
                              fontWeight: FontWeight.w300,
                              fontFamily: freesentation,
                              fontSize: 20
                          ),),
